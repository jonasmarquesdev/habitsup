    ...
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <div className="mt-3 flex flex-col gap-3">
        {availableWeekDays.map((weekDay, index) => (
          ...
          >
            <div className="h-8 w-8 flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 rounded-lg group-data-[state=checked]:bg-violet-500 transition-colors group-focus:ring-2 group-focus:ring-violet-500 group-focus:ring-offset-2 group-focus:ring-offset-background">
              <Checkbox.Indicator>
      ...
      <button
        type="submit"
        className="mt-4 lg:mt-6 rounded-lg p-2 lg:p-4 flex items-center justify-center gap-3 font-semibold transition-colors border border-violet-500  text-white hover:bg-violet-700 hover:border-violet-400 hover:text-white"
      >
